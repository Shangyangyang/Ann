...
public class PdfReport {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            // 加密
//            writer.setEncryption("123456".getBytes(), "654321".getBytes(),
//                    PdfWriter.ALLOW_SCREENREADERS,
//                    PdfWriter.STANDARD_ENCRYPTION_128);
            writer.setPageEvent(new Watermark("济南市残联信息化平台（智慧残联）"));// 水印
            writer.setPageEvent(new MyHeaderFooter());// 页眉/页脚

            // 3.打开文档
            document.open();
            document.addTitle("Title@PDF-Java");// 标题
            document.addAuthor("Author@newheyd");// 作者
            document.addSubject("Subject@citizenInfo");// 主题
            document.addKeywords("Keywords@citizenInfo");// 关键字
            document.addCreator("Creator@newheyd");// 创建者
    ...
    public void generatePDF(Document document) throws Exception {
        ...
        // 段落
        Paragraph paragraph = new Paragraph("残疾人档案信息", titlefont);
        ...
        table.addCell(createCell("张三，3701XXXXXXXXXXX1234", headfont, Element.ALIGN_LEFT, 6, false));
